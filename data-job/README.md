...
- 10:25/11:25/12:25/13:25/14:25 北京时间：`auction`，每小时补偿刷新线上 JSON；若已有 9:25 竞价结果，会保留竞价确认，避免用盘中行情改写集合竞价判断。

目前已经覆盖：

- 04:17/06:17/08:17：使用现有公开源或 fixture 先写缓存，降低 08:37 一次性抓取压力。
- 08:37：市场涨跌家数、热门概念、概念内个股行情、成交额、换手率、涨跌幅、代码名称匹配，并发布准备名单。
- 9:25/9:32/10:25/11:25/12:25/13:25/14:25：只对 08:37 池子拉取公开行情快照；9:35 后的运行用于补偿发布和刷新数据新鲜度，已有 9:25 竞价结果时会保留原竞价确认。
